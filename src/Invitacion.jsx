  ...
  return (
    <main className="invitacion">
      ...
      <div className="contenido">
        ...
        <Reveal><section className="card rsvp"><h2>¿Nos acompañas?</h2><p className="mensaje-confirmacion">Para organizar cada detalle con el cuidado que este día merece, te pedimos confirmar tu asistencia a más tardar el <b>20 de octubre de 2026</b>.</p><p className="mensaje-confirmacion nota-alimentaria">Por favor indícanos si tienes alguna <strong>alergia o preferencia alimentaria</strong> (<strong>vegano/vegetariano</strong>) al confirmar tu asistencia.</p><div className="acciones"><a className="principal" href={`https://wa.me/573233252242?text=${mensaje}`} target="_blank" rel="noreferrer">Confirmar con Oscar</a><a className="principal" href={`https://wa.me/573134782033?text=${mensaje}`} target="_blank" rel="noreferrer">Confirmar con Laura</a><a href={calendar} target="_blank" rel="noreferrer">Guardar fecha</a></div></section></Reveal>
